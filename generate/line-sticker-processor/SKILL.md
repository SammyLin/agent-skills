...
description: 處理 LINE 貼圖的完整工具，包含圖片切割、去背、調整大小和 metadata 生成。當用戶需要處理 LINE 貼圖圖片時使用，包括：(1) 從組合圖中切割個別貼圖, (2) 去除背景並設為透明, (3) 調整為 LINE 規格尺寸 (主畫面圖 240x240、聊天小圖示 96x74、貼圖 370x320), (4) 生成中英文標題和說明建議。
---
